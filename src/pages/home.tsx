...
const HeroSection = () => {
  return (
    <div className="container pt-10 px-6 lg:flex xl:px-40">
      ...
      <div className="flex flex-col items-center lg:w-1/2 lg:mt-8 lg:items-start">
        <div className="md:max-w-[555px] lg:max-w-max">
          ...
          <p className="text-center text-base text-dark-light leading-7 mb-[60px] md:text-xl md:mb-7
            lg:text-start lg:text-lg 2xl:text-xl">
